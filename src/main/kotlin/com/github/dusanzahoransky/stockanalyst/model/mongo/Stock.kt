...
data class Stock(
    ...
    var totalDebtEquity: SortedMap<LocalDate, Double> = TreeMap(),
    ...
    var profitMarginQ: SortedMap<LocalDate, Long> = TreeMap(),
    ...
    var stock: SortedMap<LocalDate, Double> = TreeMap(),
    var stockQ: SortedMap<LocalDate, Double> = TreeMap(),
    var stockGrowth: SortedMap<LocalDate, Double> = TreeMap(),
    var stockGrowthQ: SortedMap<LocalDate, Double> = TreeMap(),
