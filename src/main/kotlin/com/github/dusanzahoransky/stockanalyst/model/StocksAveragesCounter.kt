...
data class StocksAveragesCounter(
    ...
    var buyPercentInsiderSharesCount: Int = 0,
    var sellPercentInsiderSharesCount: Int = 0,
...
//    var belowStickerPrice10pcCount: Int = 0,
    ...
    var currentRatio2YearsAgoCount: Int = 0,
    var currentRatio3QuartersAgoCount: Int = 0,
    var currentRatio4YearsAgoCount: Int = 0,
    var currentRatioGrowthLast2QuartersCount: Int = 0,
    var currentRatioGrowthLast4YearsCount: Int = 0,
    var currentRatioGrowthLastYearCount: Int = 0,
    var currentRatioLastQuarterCount: Int = 0,
    var currentRatioLastYearCount: Int = 0,
    var profitMargin2QuartersAgoCount: Int = 0,
    var profitMargin2YearsAgoCount: Int = 0,
    var profitMargin3QuartersAgoCount: Int = 0,
    var profitMargin4YearsAgoCount: Int = 0,
    var profitMarginLastQuarterCount: Int = 0,
    var profitMarginLastYearCount: Int = 0,
    var currentAssets2QuartersAgoCount: Int = 0,
    var currentAssets2YearsAgoCount: Int = 0,
    var currentAssets3QuartersAgoCount: Int = 0,
    var currentAssets4YearsAgoCount: Int = 0,
    ...
    var currentLiabilities3QuartersAgoCount: Int = 0,
    var currentLiabilities4YearsAgoCount: Int = 0,
    var currentLiabilitiesLastQuarterCount: Int = 0,
    var currentRatio2QuartersAgoCount: Int = 0,
    var currentRatioGrowthLastQuarterCount: Int = 0,
    var profitMarginGrowthLast2QuartersCount: Int = 0,
    var profitMarginGrowthLast4YearsCount: Int = 0,
    var profitMarginGrowthLastQuarterCount: Int = 0,
    var profitMarginGrowthLastYearCount: Int = 0,
    var roicLast2YearsAgoCount: Int = 0,
    var roicLast4YearsAgoCount: Int = 0,
    var roicLastYearCount: Int = 0
)