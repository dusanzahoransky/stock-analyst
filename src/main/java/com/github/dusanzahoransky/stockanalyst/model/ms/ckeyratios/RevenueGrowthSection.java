...
public class RevenueGrowthSection {
    ...
    public String toString() {
        ...
        sb.append(RevenueGrowthSection.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RevenueGrowthSection) == false) {
            return false;
        }
        RevenueGrowthSection rhs = ((RevenueGrowthSection) other);
