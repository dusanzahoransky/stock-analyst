...
package com.github.dusanzahoransky.stockanalyst.model.yahoo.analysis;
...
public class EpsTrend {
    ...
    private com.github.dusanzahoransky.stockanalyst.model.yahoo.analysis._7daysAgo _7daysAgo;
    @JsonProperty("30daysAgo")
    private com.github.dusanzahoransky.stockanalyst.model.yahoo.analysis._30daysAgo _30daysAgo;
    @JsonProperty("60daysAgo")
    private com.github.dusanzahoransky.stockanalyst.model.yahoo.analysis._60daysAgo _60daysAgo;
    @JsonProperty("90daysAgo")
    private com.github.dusanzahoransky.stockanalyst.model.yahoo.analysis._90daysAgo _90daysAgo;
    @JsonIgnore
    ...
    @JsonProperty("7daysAgo")
    public com.github.dusanzahoransky.stockanalyst.model.yahoo.analysis._7daysAgo get7daysAgo() {
        return _7daysAgo;
    }

    @JsonProperty("7daysAgo")
    public void set7daysAgo(com.github.dusanzahoransky.stockanalyst.model.yahoo.analysis._7daysAgo _7daysAgo) {
        this._7daysAgo = _7daysAgo;
    }

    @JsonProperty("30daysAgo")
    public com.github.dusanzahoransky.stockanalyst.model.yahoo.analysis._30daysAgo get30daysAgo() {
        return _30daysAgo;
    }

    @JsonProperty("30daysAgo")
    public void set30daysAgo(com.github.dusanzahoransky.stockanalyst.model.yahoo.analysis._30daysAgo _30daysAgo) {
        this._30daysAgo = _30daysAgo;
    }

    @JsonProperty("60daysAgo")
    public com.github.dusanzahoransky.stockanalyst.model.yahoo.analysis._60daysAgo get60daysAgo() {
        return _60daysAgo;
    }

    @JsonProperty("60daysAgo")
    public void set60daysAgo(com.github.dusanzahoransky.stockanalyst.model.yahoo.analysis._60daysAgo _60daysAgo) {
        this._60daysAgo = _60daysAgo;
    }

    @JsonProperty("90daysAgo")
    public com.github.dusanzahoransky.stockanalyst.model.yahoo.analysis._90daysAgo get90daysAgo() {
        return _90daysAgo;
    }

    @JsonProperty("90daysAgo")
    public void set90daysAgo(com.github.dusanzahoransky.stockanalyst.model.yahoo.analysis._90daysAgo _90daysAgo) {
