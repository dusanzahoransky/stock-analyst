...
public class NetIncomeGrowthSection {
    ...
    public String toString() {
        ...
        sb.append(NetIncomeGrowthSection.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NetIncomeGrowthSection) == false) {
            return false;
        }
        NetIncomeGrowthSection rhs = ((NetIncomeGrowthSection) other);
