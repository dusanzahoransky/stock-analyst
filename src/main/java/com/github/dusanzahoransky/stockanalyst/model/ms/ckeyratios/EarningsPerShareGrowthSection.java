...
public class EarningsPerShareGrowthSection {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EarningsPerShareGrowthSection) == false) {
            return false;
        }
        EarningsPerShareGrowthSection rhs = ((EarningsPerShareGrowthSection) other);
